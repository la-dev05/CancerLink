        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/get-medicines" className="text-muted-foreground hover:text-foreground transition-colors">
                  Get Medicines
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/online-consultation" className="text-muted-foreground hover:text-foreground transition-colors">
                  Online Consultation
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/doctor-registration" className="text-muted-foreground hover:text-foreground transition-colors">
                  For Doctors
                </Link>
              </li>
            </ul>
