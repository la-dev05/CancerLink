...
const facilities = [
  ...
  },
  {
    ...
    yearsOperating: 35,
    costRating: 2,
    specialties: ["Colorectal Cancer", "Leukemia", "Lymphoma", "Pediatric Oncology", "Breast Cancer"],
  ...
  },
  {
    ...
    yearsOperating: 12,
    costRating: 5,
    specialties: ["Precision Medicine", "Genomic Testing", "Rare Cancers", "Clinical Trials", "Breast Cancer"],
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            {facility.specialties.slice(0, 3).map((specialty, index) => (
              <span 
                key={index} 
                className={`px-2 py-1 text-xs rounded-full ${specialty.toLowerCase().includes("breast") ? "bg-cancer-purple/20 text-cancer-purple font-medium" : "bg-muted"}`}
              >
                {specialty}
              </span>
            ))}
    ...
    <Layout>
      <div className="py-12 md:py-16 container">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h1 className="text-3xl font-bold tracking-tighter mb-4">AI-Powered Symptom & Care Finder</h1>
          <p className="text-muted-foreground text-lg">
            Describe your symptoms and we'll analyze them to find the most appropriate care centers for your needs.
          </p>
        </div>
          ...
          {!showResults ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Describe your symptoms and get AI-powered guidance on potential concerns and specialized care centers
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="space-y-8">
              ...
              <div>
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold">Recommended Care Centers</h2>
                  <Tabs 
                  ...
                  <TabsContent value="recommendations" className="mt-0">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <Select defaultValue="relevance">
                        ...
                        <SelectContent>
                          <SelectItem value="relevance">Relevance to Symptoms</SelectItem>
                    ...
                    <div className="bg-muted rounded-lg flex items-center justify-center min-h-[400px]">
                      <div className="text-center p-8">
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto">
                          The interactive map would display care centers that specialize in treating the conditions identified in your symptom analysis.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                      ...
                      <CardContent>
                        <div className="overflow-x-auto">
                          <table className="w-full border-collapse">
                            <thead>
                              <tr className="border-b">
                                ...
                                {facilities
                                  ...
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <th key={facility.id} className="text-left py-3 px-4 font-medium">
                            ...
                            <tbody>
                              <tr className="border-b">
                                <td className="py-3 px-4 font-medium">Specialties</td>
                                {facilities
                                  .sort((a, b) => b.relevance - a.relevance)
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <td key={`specialties-${facility.id}`} className="py-3 px-4">
                                      <div className="flex flex-wrap gap-1">
                                        {facility.specialties
                                          .filter(s => s.toLowerCase().includes("breast"))
                                          .map((specialty, i) => (
                                            <Badge key={i} variant="secondary" className="bg-cancer-purple/20 text-cancer-purple">
                                              {specialty}
                                            </Badge>
                                          ))}
                                        {facility.specialties
                              ...
                              <tr className="border-b">
                                <td className="py-3 px-4 font-medium">Treatments</td>
                                {facilities
                                  .sort((a, b) => b.relevance - a.relevance)
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <td key={`treatments-${facility.id}`} className="py-3 px-4">
                                      {facility.treatments.slice(0, 3).join(", ")}
                                    </td>
                                  ))}
                              </tr>
                              <tr className="border-b">
                                <td className="py-3 px-4 font-medium">Cost Level</td>
                                {facilities
                                  .sort((a, b) => b.relevance - a.relevance)
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <td key={`cost-${facility.id}`} className="py-3 px-4">
                                      <CostIndicator level={facility.costRating} />
                                    </td>
                                  ))}
                              </tr>
                              <tr className="border-b">
                                ...
                                {facilities
                                  ...
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <td key={`insurance-${facility.id}`} className="py-3 px-4">
                              ...
                              <tr>
                                ...
                                {facilities
                                  ...
                                  .slice(0, 3)
                                  .map((facility) => (
                                    <td key={`contact-${facility.id}`} className="py-3 px-4">
              ...
              <Card className="bg-yellow-50 border-yellow-200">
                <CardContent className="pt-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-yellow-800 mb-2">Important Medical Notice</h3>
          ...
          {!showResults && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Our AI analyzes your symptoms and helps you find the most appropriate care
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enter detailed information about your symptoms, including location, severity, and duration.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          We find specialized care centers that focus on treating your potential condition.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Review and compare care centers based on specialties, insurance, cost, and other factors.
                        </p>
                      </div>
                    </div>
                  </div>
